...
\begin{itemize}
	...
	\item for csh
     ...
     if appending: \exec{setenv LD\_LIBRARY\_PATH \$\{LD\_LIBRARY\_PATH\}:/path/to/build/directory/ccpp-physics}

     if setting: \exec{setenv LD\_LIBRARY\_PATH path/to/build/directory/ccpp-physics}
\end{itemize}
...
\url{https://dtcenter.org/gmtb/users/ccpp/}
