...
contains
  ...
  subroutine effr_diag_run(effrr_in, scalar_var, errmsg, errflg)
    ...
    integer, intent(out) :: errflg
    !----------------------------------------------------------------
    real(kind=kind_phys) :: effrr_min, effrr_max
  ...
  subroutine cmp_effr_diag(effr, effr_min, effr_max)
    real(kind=kind_phys), intent(in) :: effr(:, :)
    real(kind=kind_phys), intent(out) :: effr_min, effr_max
