...
#    'ccpp/physics/physics/GFS_DCNV_generic.f90',           : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_MP_generic_post.f90',        : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_MP_generic_pre.f90',         : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_PBL_generic.f90',            : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_SCNV_generic.f90',           : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_calpreciptype.f90',          : [ 'fast_physics' ],
    'ccpp/physics/physics/GFS_debug.F90',                  : [ 'fast_physics' ],
    'ccpp/physics/physics/GFS_rrtmg_post.F90',             : [ 'fast_physics' ],
    'ccpp/physics/physics/GFS_rrtmg_pre.F90',              : [ 'fast_physics' ],
    'ccpp/physics/physics/GFS_rrtmg_setup.F90',            : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_stochastics.f90',            : [ 'fast_physics' ],
    'ccpp/physics/physics/GFS_suite_interstitial.F90',     : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_surface_generic.f90',        : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_surface_loop_control.f',     : [ 'fast_physics' ],
#    'ccpp/physics/physics/GFS_zhao_carr_pre.f90',          : [ 'fast_physics' ],
    'ccpp/physics/physics/cnvc90.f',                       : [ 'fast_physics' ],
#    'ccpp/physics/physics/dcyc2.f',                        : [ 'fast_physics' ],
#    'ccpp/physics/physics/get_prs_fv3.f90',                : [ 'fast_physics' ],
