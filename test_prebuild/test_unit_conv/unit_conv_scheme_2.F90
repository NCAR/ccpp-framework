...
module unit_conv_scheme_2
  ...
  real(kind=kind_phys), parameter :: target_value = 1.0E-3_kind_phys
...
contains
  ...
  subroutine unit_conv_scheme_2_run(data_array, data_array2, data_array_opt, errmsg, errflg)
    ...
    write(error_unit, '(a,e12.4)') &
        'In unit_conv_scheme_2_run: checking min/max values of data array to be approximately ', target_value
    ...
    write(error_unit, '(a,e12.4)') &
        'In unit_conv_scheme_2_run: checking min/max values of data array 2 to be approximately ', target_value2
    ...
    write(error_unit, '(a,e12.4)') &
        'In unit_conv_scheme_2_run: checking min/max values of optional data array to be approximately ', target_value
