...
SCHEME_FILES = [
    'unit_conv_scheme_1.F90',
    'unit_conv_scheme_2.F90',
    ]
...
HTML_VARTABLE_FILE = '{build_dir}/CCPP_VARIABLES_UNIT_CONV.html'

# LaTeX document containing the provided vs requested CCPP variables
LATEX_VARTABLE_FILE = '{build_dir}/CCPP_VARIABLES_UNIT_CONV.tex'
